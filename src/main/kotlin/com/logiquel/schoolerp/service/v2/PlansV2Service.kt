...
import com.logiquel.schoolerp.dto.v2.PlanModuleResponseV2
...
class PlansV2Service(
    ...
    // GET ALL
    // ─────────────────────────────────────
    fun findAll(): ApiResponse<List<PlanResponseV2>> {
    ...
    // GET BY ID
    // ─────────────────────────────────────
    fun findById(id: UUID): ApiResponse<PlanResponseV2> {
    ...
    // GET BY TENANT ID
    // ─────────────────────────────────────
    fun findByTenantId(tenantId: UUID): ApiResponse<PlanResponseV2> {
    ...
    // ─────────────────────────────────────
    @Transactional
    fun create(request: CreatePlanRequest): ApiResponse<PlanResponseV2> {
    ...
    // ─────────────────────────────────────
    @Transactional
    fun update(id: UUID, request: UpdatePlanRequest): ApiResponse<PlanResponseV2> {
    ...
    // ─────────────────────────────────────
    @Transactional
    fun addModule(planId: UUID, request: AddModuleToPlanRequest): ApiResponse<PlanResponseV2> {
    ...
    // ─────────────────────────────────────
    @Transactional
    fun removeModule(planId: UUID, moduleId: UUID): ApiResponse<PlanResponseV2> {
    ...
    // Mapper
    // ─────────────────────────────────────
    private fun PlanEntityV2.toResponse(): PlanResponseV2 {
    ...
    private fun PlanModuleEntityV2.toModuleResponse() = PlanModuleResponseV2(
        id = id!!,
        moduleId = module.id!!,
